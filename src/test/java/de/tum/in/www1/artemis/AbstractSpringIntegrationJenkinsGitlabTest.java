...
@SpringBootTest(classes = ArtemisApp.class, properties = { "artemis.athene.token-validity-in-seconds=10800",
...
@ActiveProfiles({ "artemis", "gitlab", "jenkins", "athene", "testcontainers" })
