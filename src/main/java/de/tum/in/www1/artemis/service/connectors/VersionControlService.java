...
public interface VersionControlService {
    ...
    /**
     * Releases the Exercise by allowing all students of the course to read the solution repository.
     *
     * @param programmingExercise the exercise being released
     */
    void releaseSolutionFor(ProgrammingExercise programmingExercise) throws GitLabApiException;
